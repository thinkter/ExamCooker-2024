...
type SitemapCollectionRouteParams = Promise<{ collection: string }>;
type ResolvedSitemapCollectionRouteParams =
  Awaited<SitemapCollectionRouteParams>;
...
export async function GET(
  req: NextRequest,
  { params }: { params: SitemapCollectionRouteParams },
) {
  const { collection }: ResolvedSitemapCollectionRouteParams = await params;
